...
ActiveRecord::Schema[7.0].define(version: 2023_05_16_123124) do
  ...
  create_table "book_categories", force: :cascade do |t|
    ...
    t.index ["book_id", "category_id"], name: "index_book_categories_on_book_id_and_category_id"
    t.index ["book_id"], name: "index_book_categories_on_book_id"
    t.index ["category_id", "book_id"], name: "index_book_categories_on_category_id_and_book_id"
